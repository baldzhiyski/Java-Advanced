...
//Print Egg
        ...
        //Get egg
        Egg getEgg = basket.getEgg("Green"); //Green egg with 9 strength, pointy shap
        System.out.println(getEgg);
        System.out.println(basket.report()); //Wood basket contains: //Red egg, with 10 strength and oval shape. //Green egg, with 9 strength and pointy shape.
